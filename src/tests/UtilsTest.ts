...
const sampleRequest: HttpRequest = {
    ...
    "response": {
        "headers": {
            ...
            "content-language": "en",
            "bad-header": "some forbidden ${chars}",
...
describe(" > Utils", function () {
    ...
    it('Should replace template string var sequence', () => {
        const transformed = Utils.stringifyRawRequests(sampleRequest);
        assert.isTrue(transformed.indexOf('\$') === -1);
    });
